...
class Model_category extends CI_Model
{
	...
	public function stok($data, $id)
	{
		if($data && $id) {
			$this->db->where('banyak_barang', $banyak_barang,'jml_barang', $jml_barang);
			$stok = $banyak_barang - $jml_barang;
			$update = $this->db->update('banyak_barang', $data);
