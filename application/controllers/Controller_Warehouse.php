...
class Controller_Warehouse extends Admin_Controller 
{
    ...
    */
	public function create()
	{
		...
		$this->form_validation->set_rules('store_alamat', 'alamat', 'trim|required');
        ...
        if ($this->form_validation->run() == TRUE) {
        	$data = array(
				...
				'name' => $this->input->post('store_alamat'),
    ...
    */
	public function update($id)
	{
		...
		if($id) {
			...
			$this->form_validation->set_rules('edit_store_alamat', 'alamat', 'trim|required');
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	$data = array(
					...
					'name' => $this->input->post('edit_store_alamat'),
