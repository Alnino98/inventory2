      ...
      <form role="form" action="<?php echo base_url('Controller_Items/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="kode_barang" name="kode_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="jenis_barang">Jenis Barang</label>
            <input type="text" class="form-control" id="jenis_barang" name="jenis_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="nama_barang">Nama Barang</label>
            <input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="banyak_barang">Banyak Barang</label>
            <input type="text" class="form-control" id="banyak_barang" name="banyak_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="tgl_masuk">Tanggal Masuk</label>
            <input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
      ...
      <form role="form" action="<?php echo base_url('Controller_Items/update') ?>" method="post" id="updateBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="edit_kode_barang" name="edit_kode_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="edit_jenis_barang">Jenis Barang</label>
            <input type="text" class="form-control" id="edit_jenis_barang" name="edit_jenis_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="edit_nama_barang">Nama Barang</label>
            <input type="text" class="form-control" id="edit_nama_barang" name="edit_nama_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="edit_banyak_barang">Banyak Barang</label>
            <input type="text" class="form-control" id="edit_banyak_barang" name="edit_banyak_barang" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="edit_tgl_masuk">Tanggal Masuk</label>
            <input type="date" class="form-control" id="edit_tgl_masuk" name="edit_tgl_masuk" placeholder="Enter item name" autocomplete="off">
          </div>
          <div class="form-group">
