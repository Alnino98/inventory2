      ...
      <form role="form" action="<?php echo base_url('Controller_Warehouse/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="store_alamat" name="store_alamat" placeholder="Enter warehouse name" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Controller_Warehouse/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_alamat">alamat</label>
            <input type="text" class="form-control" id="edit_store_alamat" name="edit_store_alamat" placeholder="Enter alamat" autocomplete="off">
          </div>
          <div class="form-group">
